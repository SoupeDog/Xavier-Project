...
public class Universal_500_X_Exception_Runtime extends ServiceException_Runtime {
    ...
    public Universal_500_X_Exception_Runtime(Float stateCode, String msg) {
        super(stateCode, msg);
    }

    public Universal_500_X_Exception_Runtime(Float stateCode, String msg, Throwable cause) {
        super(stateCode, msg, cause);
    }

    public Universal_500_X_Exception_Runtime(Float stateCode, String msg, String extraInfo) {
        super(stateCode, msg, extraInfo);
    }

    public Universal_500_X_Exception_Runtime(Float stateCode, String msg, String extraInfo, Throwable cause) {
