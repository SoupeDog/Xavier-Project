...
public class RequestException_Runtime extends RuntimeException {
    ...
    public RequestException_Runtime(Double stateCode, String msg) {
        super(msg);
        this.stateCode = stateCode;
    }

    public RequestException_Runtime(Double stateCode, String msg, Throwable cause) {
        super(msg, cause);
        this.stateCode = stateCode;
    }

    public RequestException_Runtime(Double stateCode, String msg, String extraInfo) {
        super(msg);
        this.stateCode = stateCode;
        this.extraInfo = extraInfo;
    }

    public RequestException_Runtime(Double stateCode, String msg, String extraInfo, Throwable cause) {
        super(msg, cause);
        this.stateCode = stateCode;
        this.extraInfo = extraInfo;
    }
