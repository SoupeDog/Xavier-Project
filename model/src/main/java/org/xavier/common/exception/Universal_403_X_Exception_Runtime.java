...
public class Universal_403_X_Exception_Runtime extends RequestException_Runtime {
    ...
    public Universal_403_X_Exception_Runtime(Double stateCode, String msg) {
        super(stateCode, msg);
    }

    public Universal_403_X_Exception_Runtime(Double stateCode, String msg, Throwable cause) {
        super(stateCode, msg, cause);
    }

    public Universal_403_X_Exception_Runtime(Double stateCode, String msg, String extraInfo) {
        super(stateCode, msg, extraInfo);
    }

    public Universal_403_X_Exception_Runtime(Double stateCode, String msg, String extraInfo, Throwable cause) {
